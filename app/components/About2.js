...
const About2 = () => {
  return (
    ...
    <Image src={'/iphone background.jpg'} width={1000} height={200} alt='iphone background image' className='w-full h-full max-md:h-[60vh] max-md:mr-10 mx-8' />
    </div>
...
<b className='text-3xl font-bold'>5g</b></p></div>
    ...
    <span><Image src={'/plus.svg'} width={30} height={20} alt='plus img'/></span>
    </button>
    </div>
